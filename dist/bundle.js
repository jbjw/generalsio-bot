...
var socket = exports.socket = __webpack_require__(41)('http://botws.generals.io');

var userId = 'my_example_bot_id';
...
var userIdInput = qs("#user-id-input");
var userIdButton = qs("#user-id-button");

userIdButton.addEventListener('click', function (e) {
	_bot2.default.setUserId(e.target.value);
	userIdInput.value = '';
});
